...
const ServiceReviewScreen = ({ route, navigation }) => {
    ...
    const handleSubmit = () => {
        fetch('https://open-sg.larksuite.com/anycross/trigger/callback/MDQ3NTg0YmRiNzNiYmE2NWUyYzU1ODg5MjIyY2RjNTdl', {
            method: 'POST',
            headers: { "Accept-Encoding": "gzip", },
            body: JSON.stringify({
                name,
                rating: parseInt(rating),
                ratingservice: lastClassOption === 'Đúng, đây là buổi học cuối của tôi' ? parseInt(ratingservice) : null,
                selectedOption,
                issueOption,
                contactOption: issueOption === 'Có' ? contactOption : 'Không',
                lastClassOption,
                additionalField1: (selectedOption === 'Bình thường' || selectedOption === 'Không hài lòng' || selectedOption === 'Rất không hài lòng') ? additionalField1 : null,
                additionalField2: issueOption === 'Có, tôi có vấn đề cần hỗ trợ' ? additionalField2 : null,
            ...
            .then(() => {
                // Dùng alert() cho web thay vì Alert.alert()
